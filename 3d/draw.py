...
def generate_torus( points, cx, cy, cz, r0, r1, step ):
	...
	while rotation <= 1:
		circle = 0
		while circle <= 1:
			x = r0 * math.cos( math.pi * circle ) + cx
			y = ( r0 * math.sin( math.pi * circle ) + r1 ) * math.cos( 2 * math.pi * rotation ) + cy
			z = ( r0 * math.sin( math.pi * circle ) + r1 ) * math.sin( 2 * math.pi * rotation ) + cz
			add_edge( points, x, y, z, x, y, z )
			circle += step
		rotation += step
